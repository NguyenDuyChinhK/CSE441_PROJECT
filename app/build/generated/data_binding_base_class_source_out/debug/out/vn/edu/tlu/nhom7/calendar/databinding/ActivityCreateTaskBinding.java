...
public final class ActivityCreateTaskBinding implements ViewBinding {
  ...
  private ActivityCreateTaskBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnCreateTask, @NonNull EditText etDate, @NonNull EditText etEndTime,
      ...
      @NonNull ImageView imageStartTime, @NonNull ImageButton imgButtonback,
      @NonNull ConstraintLayout main, @NonNull Spinner spAlarmTime, @NonNull Spinner spColor,
  ...
  public static ActivityCreateTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCreateTaskBinding((ConstraintLayout) rootView, btnCreateTask, etDate,
          etEndTime, etLocation, etStartTime, etTaskDescription, etTaskName, imageAlarmTime,
          imageCalendar, imageColor, imageEndTime, imageStartTime, imgButtonback, main, spAlarmTime,
          spColor, title);
    }
