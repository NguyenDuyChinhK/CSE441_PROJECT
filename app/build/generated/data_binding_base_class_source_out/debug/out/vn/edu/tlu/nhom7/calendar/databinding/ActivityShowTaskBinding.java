...
public final class ActivityShowTaskBinding implements ViewBinding {
  ...
  private ActivityShowTaskBinding(@NonNull ConstraintLayout rootView, @NonNull TextView color,
      @NonNull ImageButton imgButtonback, @NonNull ConstraintLayout main,
      @NonNull TextView showAlarmTime, @NonNull TextView showDate, @NonNull TextView showEndTime,
      @NonNull ImageView showImageAlarmTime, @NonNull ImageView showImageColor,
      @NonNull ImageView showImageDate, @NonNull ImageView showImageLocation,
      @NonNull TextView showLocation, @NonNull TextView showSpace, @NonNull TextView showStartTime,
      @NonNull TextView showTaskDescription, @NonNull TextView showTaskName,
      @NonNull TextView space, @NonNull TextView space2, @NonNull TextView title) {
  ...
  public static ActivityShowTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.space2;
      TextView space2 = ViewBindings.findChildViewById(rootView, id);
      if (space2 == null) {
        break missingId;
      }
      ...
      return new ActivityShowTaskBinding((ConstraintLayout) rootView, color, imgButtonback, main,
          showAlarmTime, showDate, showEndTime, showImageAlarmTime, showImageColor, showImageDate,
          showImageLocation, showLocation, showSpace, showStartTime, showTaskDescription,
          showTaskName, space, space2, title);
    }
